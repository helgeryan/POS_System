    ...
    public ArrayList<Item> getInventoryList() throws FileNotFoundException {
        ...
        while (sc.hasNextLine()){
            ...
            while(rowParse.hasNext()){
                items.add(new Item(Integer.parseInt(rowParse.next()), rowParse.next(), rowParse.next(), Integer.parseInt(rowParse.next()), Integer.parseInt(rowParse.next()), Integer.parseInt(rowParse.next()), Double.parseDouble(rowParse.next()), rowParse.next()));
            }
        }
        return items;
    }
